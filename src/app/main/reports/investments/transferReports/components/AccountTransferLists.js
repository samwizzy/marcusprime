...
class AccountTransferLists extends Component {

    componentDidMount(){
        this.props.getTransfers({type: 'Account Transfer'})
    }

    render()
    {
        const { transactions, filteredTransactions, isFiltering, getTransactions, getTransfers } = this.props;
        ...
        const options = {
            ...
            filter: false,
            viewColumns: false,
            downloadOptions: {filename: 'accountTransfer.csv', separator: ','},
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(AccountTransferLists)));
