...
class PtaDocTypesApp extends React.Component {
    ...
    componentDidMount(){
        ...
        this.props.getPtaDocTypes({fxCatId: 1})
    }
...
const mapStateToProps = ({ptaDocTypesApp}) => {
    console.log(ptaDocTypesApp, "docTypesApp")
    return {
    }
}
...
export default withReducer('ptaDocTypesApp', reducer)(withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(PtaDocTypesApp)));