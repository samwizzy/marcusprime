...
class DepositsMakerCheckerDialog extends Component {
...
function mapStateToProps({ depositsMCApp }) {
    const { deposits, currency } = depositsMCApp
    return {
...
export default connect(mapStateToProps, mapDispatchToProps)(DepositsMakerCheckerDialog);
