...
class ChatsSidebar extends Component {
    ...
    render() {
        ...
        const chatListContacts = user && user.key ? Object.key(user.userChat.chatList).map((_chat) => (
            {
                ..._chat,
        ...
        // console.log(chatListContacts, 'chatListContacts')
            ...
            return (
                ...
                >
                    <div className="relative">
                        ...
                        <Avatar src={contact.fullname} alt={contact.fullname}>
                            {contact.fullname}
                        </Avatar>

                        {/* <Avatar src={contact.picture === '' ? contact.fullname : contact.picture} alt={contact.fullname}>
                            {contact.picture === '' ? contact.fullname : contact.fullname}
                        </Avatar> */}
                    </div>
                        ...
                        <div className="flex flex-col justify-center items-end">
                            {contact.timestamp && (
                                <Typography className="whitespace-no-wrap mb-8">
                                    {moment(contact.timestamp).format('ll')}
                                </Typography>
                            )}
                            {contact.unread && (
                                <div
                    ...
                    <Toolbar className="flex justify-between items-center px-16 pr-4">
                        ...
                        {user && (
                            <div className="relative w-40 h-40 p-0 cursor-pointer" onClick={openUserSidebar}>
                                ...
                                <Avatar src={user.csUser.image} alt={user.csUser.adUserID} className="w-40 h-40">
                                    {(!user.csUser.image || user.csUser.image === '') ? user.csUser.adUserID : ''}
                                </Avatar>
                        ...
                        {contacts.length > 0 && (
                            <React.Fragment>
                                ...
                                >
                                    ...
                                    {chatListArr.map((contact, key) => (
                                        <ContactListItem key={key} contact={contact} />
                                    ))}
