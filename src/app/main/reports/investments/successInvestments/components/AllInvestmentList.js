...
class AllInvestmentList extends Component {
    ...
    render() {
        ...
        console.log(successfulInvestments, 'successfulInvestments')
        ...
        const options = {
            ...
            downloadOptions: {filename: 'AllSuccessfullInvestmentList.csv', separator: ','},
        ...
        return (
            <FuseAnimate animation="transition.slideUpIn" delay={300}>
                <MUIDataTable
                    title={"All Successful Investments"}
