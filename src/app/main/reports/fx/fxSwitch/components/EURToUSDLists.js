...
class EURToUSDLists extends Component {
    ...
    render()
    {
        ...
        const filterFxswitch = allFxswitch && allFxswitch.filter(fx => (fx.buyCurrency === 'EUR' && fx.sellCurrency === 'USD') || (fx.buyCurrency === 'USD' && fx.sellCurrency === 'EUR'))
        ...
        const options = {
            ...
            downloadOptions: {filename: 'EURToUSDList.csv', separator: ','},
        ...
        return (
            <FuseAnimate animation="transition.slideUpIn" delay={300}>
                <MUIDataTable
                    title={"FX Switch Report (EUR/USD)"}
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(EURToUSDLists)));
