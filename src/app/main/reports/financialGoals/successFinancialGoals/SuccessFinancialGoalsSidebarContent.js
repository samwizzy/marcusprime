...
class SuccessFinancialGoalsSidebarContent extends Component {
                    ...
                    <Paper elevation={1} className="rounded-8">
                        ...
                        <List>
                            ...
                            >
                                ...
                                <ListItemText className="truncate pr-0" primary="All Investments" disableTypography={true}/>
                            </ListItem>
                            {
...
{
    return {
        productCategories  : allProductsApp.products.productCategories,
    }
}

export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(SuccessFinancialGoalsSidebarContent)));
