...
class InvestmentTypesList extends Component {
...
function mapStateToProps({ investmentTypesApp }) {
    return {
        accounts: investmentTypesApp.investmentTypes.entities,
        ...
        user: investmentTypesApp.user
    }
}

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(InvestmentTypesList));
