...
function getSuggestions(value, accounts, { showEmpty = false } = {}) {
...
function IntegrationDownshift(props) {
  const {classes, accounts, handleChange, className } = props;
      ...
      >
        {({
          ...
          const { onBlur, onFocus, ...inputProps } = getInputProps({
            placeholder: 'Search for a user (start with a)',
          });
              ...
              <div {...getMenuProps()}>
                {isOpen ? (
                  <Paper className={classes.paper} square>
                    {getSuggestions(inputValue, accounts).map((suggestion, index) =>
                      renderSuggestion({
                        suggestion,
                        index,
