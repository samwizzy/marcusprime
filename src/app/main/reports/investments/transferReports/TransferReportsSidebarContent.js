...
class TransferReportsSidebarContent extends Component {

    render()
    {
        const {accountTypes, getAllInvestments, classes } = this.props;
                    ...
                    <Paper elevation={1} className="rounded-8">
                        ...
                        <List>
                            ...
                            >
                                ...
                                <ListItemText className="truncate pr-0" primary="All Transfers" disableTypography={true}/>
                            </ListItem>
                            {
...
{
    return {
        accountTypes: [{id: 1, name: 'Successful'}, {id: 2, name: 'Failed'}]
    }
}

export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(TransferReportsSidebarContent)));
