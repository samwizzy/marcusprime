...
const RolesAppHeader = ({setSearchText, searchText, pageLayout, mainTheme}) => {
...
{
    console.log(roleApp, "DAMN Applications");
    return {
        searchText: roleApp.mails.searchText,
        mainTheme : fuse.settings.mainTheme
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(RolesAppHeader);
