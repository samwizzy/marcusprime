...
class AccountView extends Component {
    ...
    render() {
        ...
        const { classes, saveProduct, userProfile } = this.props;
            ...
            <FusePageCarded
                ...
                contentToolbar={
                    ...
                    >
                        ...
                        <Tab className="h-64 normal-case" label="Portfolio" />
                        <Tab className="h-64 normal-case" label="Investment" />
                        <Tab className="h-64 normal-case" label="Digital Concierge" />
                        <Tab className="h-64 normal-case" label="Family" />
                    </Tabs>
                }
                content={
                                    ...
                                    <table className="simple clickable">
                                        ...
                                        <tbody>
                                            {/* {data.rows.map(row => ( */}
                                                ...
                                                <tr>
                                                    <td>Name</td>
                                                    <td>{userProfile.getUserProfile.firstName}</td>
                                                </tr>
                                                <tr>
                                                    <td>E-mail</td>
                                                    <td>{userProfile.getUserProfile.email}</td>
                                                </tr>
                                                <tr>
                                                    <td>Phone Number</td>
                                                    <td>{userProfile.getUserProfile.phoneNumber}</td>
                                                </tr>
                                                <tr>
                                                    <td>BVN</td>
                                                    <td>{userProfile.getUserProfile.bvn}</td>
                                                </tr>
                                                <tr>
                                                    <td>Address</td>
                                                    <td>{userProfile.getUserProfile.address}</td>
                                                </tr>
                                                <tr>
                                                    <td>Gender</td>
                                                    <td>{userProfile.getUserProfile.gender}</td>
                                                </tr>
                                            {/* ))} */}
                                        </tbody>
                                    </table>
...
function mapStateToProps({accountsApp}) {
    return {
        product: accountsApp.product,
        userProfile: accountsApp.accounts
    }
}
