...
class TbillsProductsDialog extends Component {
    ...
    canBeSubmitted() {
        const { initialVolume, totalVolume, bid, maturity, name, offer, bookSellRate, bookBuyRate } = this.state;
        return (
            initialVolume !== null && totalVolume !== null && bid !== null && maturity !== null && offer !== null && name !== null && bookSellRate !== '' && bookBuyRate !== ''
        );
    }
    ...
    handleChange = name => event => {
        ...
        if (name === 'initialVolume' || name === 'totalVolume' || name === 'bid' || name === 'offer' || name === 'bookBuyRate' || name === 'bookSellRate') {
            this.setState({
...
function mapStateToProps({ tbillsApp }) {
    return {
        tbillsDialog: tbillsApp.tbills.tbillsDialog,
