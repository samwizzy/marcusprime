...
const CommentToolbar = ({classes, mail, match, history, toggleStar, toggleImportant}) => {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CommentToolbar));
