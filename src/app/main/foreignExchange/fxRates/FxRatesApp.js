...
class FxRatesApp extends Component {
...
export default withReducer('fxSwitchApp', reducer)(withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(FxRatesApp))));
