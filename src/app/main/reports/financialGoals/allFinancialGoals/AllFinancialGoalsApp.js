...
import AllFinancialGoalsAppList from './AllFinancialGoalsList';
...
export default withReducer('allFinancialGoalsApp', reducer)(withStyles(styles, { withTheme: true })(withRouter(connect(mapStateToProps, mapDispatchToProps)(AllFinancialGoalsApp))));
