...
import {Icon, Link, Typography, Select, Paper, IconButton} from '@material-ui/core';
        ...
        return (
            <Paper className="w-full rounded-8 shadow-none border-1">
                <div className="flex items-center justify-between pr-4 pl-16 pt-4">
                    <Typography component="div" className="text-16">
                        <Link
                            ...
                            variant="body1"
                            onClick={() => {
                                this.props.history.push('/apps/tickets/all')
                            }}
                        >
                            All Tickets
                        </Link>    
                ...
                <div className="text-center pt-12 pb-28">
                    <Typography
                        className="text-72 leading-none text-blue">{widget.count}</Typography>
