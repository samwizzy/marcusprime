...
class CreditedLists extends Component {
    ...
    render()
    {
        ...
        const footerNames = ['ID', 'TRANS. TYPE', 'NARRATION', 'DIRECTION', 'BENEFICIARY', 'REFERENCE N0.', 'STATUS', 'DATE', 'AMOUNT', 'DATE CREATED'];
        ...
        const options = {
            ...
            downloadOptions: {filename: 'creditedTransactions.csv', separator: ','},
            filter: false,
            print: false,
            viewColumns: false,
            ...
            customToolbar: () => {
                return (
                    <AddButton direction={{direction: 'credit'}} />
                );
            }
        };
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(CreditedLists)));
