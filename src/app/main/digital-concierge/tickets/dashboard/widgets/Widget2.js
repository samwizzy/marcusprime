                ...
                <div className="flex items-center justify-between pr-4 pl-16 pt-4">
                    <Typography component="div" className="text-16">
                        <Link
                            ...
                            variant="body1"
                            onClick={() => {
                                this.props.history.push('/apps/tickets/0')
                            }}
                        >
                            New
                        </Link>
...
export default withRouter(Widget2);
