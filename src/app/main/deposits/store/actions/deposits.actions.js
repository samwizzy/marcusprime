...
export const DISABLE_DEPOSIT_RATE = '[FIXED DEPOSIT APP] DISABLE FIXED DEPOSIT RATE';
export const ENABLE_DEPOSIT_RATE = '[FIXED DEPOSIT APP] ENABLE FIXED DEPOSIT RATE';
...
export function addDepositRate(data) 
{
    ...
    return (dispatch) =>
        request.then((response) => {
            if(response.data && response.data.success === false && response.data.code === '101'){
